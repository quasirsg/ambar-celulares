    ...
    r = (function () {
      function t(n) {
        ...
        return (
          e(this, t),
          (this._node =
            n instanceof HTMLElement ? n : document.createElement(n)),
          (this._config = { i18n: s }),
          this._setAttributes(i),
          i.textContent && this._setTextContent(i.textContent),
          this
        );
      }
      return (
    ...
    function t(n, i) {
      e(this, t),
        (this._config = o(
          o({}, i),
          {},
          { classNames: o(o({}, u), i.classNames), disabledOptions: [] }
        )),
        ...
        (this._body = new r(document.body)),
        this._create(n),
      ...
      n(t, [
        ...
        },
        {
          ...
          value: function (e) {
            ...
            (this._parent = new r(t)),
              (this._select = new r("div", {
                class: this._config.classNames.select,
              })),
              (this._label = new r("span", {
                class: this._config.classNames.label,
              })),
              (this._optionsWrapper = new r("div", {
          ...
          value: function () {
            ...
            return (
              this._config.autocomplete &&
                ((this._autocomplete = new r("input", {
              ...
              this._config.options.map(function (t) {
                var n = new r("div", {
                  class: ""
                    .concat(e._config.classNames.option)
                    .concat(
                      t.disabled
                        ? " " + e._config.classNames.optionDisabled
                        : ""
                    ),
                  value: t.value,
                  textContent: t.label,
                ...
                return (
                  t.disabled && e._config.disabledOptions.push(String(t.value)),
                  e._optionsWrapper.append(n.get()),
                  n
                );
              })
            );
        ...
        },
        {
          ...
          value: function (e) {
            if (
              (e.stopPropagation(),
              e.target.className !== this._config.classNames.autocompleteInput)
            ) {
              if (this._state.opened) {
                ...
                return (
                  t && this._setValue(t.get().getAttribute("data-value"), !0),
              ...
              e.target.className !== this._config.icon &&
          ...
          value: function (e, t, n) {
            ...
            if (!(this._config.disabledOptions.indexOf(e) > -1)) {
              ...
              var o = this._config.value
                ...
                l = this._options.find(function (e) {
                  return (
                    e.get().getAttribute("data-value") === o.value.toString()
                  );
                });
              this._config.value
                ? (l.addClass(this._config.classNames.selectedOption),
                  this._placeholder.addClass(
                    this._config.classNames.placeholderHidden
                  ),
          ...
          value: function (e, t) {
            ...
            this._label.setText(""),
              (this._icons = e.map(function (e) {
                var t = new r("span", {
                    class: n._config.classNames.selectedLabel,
                    textContent: e.label,
                  }),
                  i = new r(
                    n._config.inlineIcon
                      ? n._config.inlineIcon.cloneNode(!0)
                      : "i",
                    { class: n._config.icon, value: e.value }
                  );
                return (
                  i.addEventListener("click", n._boundUnselectOption),
                  t.append(i.get()),
                  n._label.append(t.get()),
                  i.get()
                );
              })),
              t &&
          ...
          value: function (e) {
            ...
            this._options.forEach(function (n) {
              n
                ...
                ? n.removeClass(t._config.classNames.optionHidden)
                : n.addClass(t._config.classNames.optionHidden);
            });
          },
        },
      ]),
